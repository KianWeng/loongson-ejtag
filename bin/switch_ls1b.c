...
#define MDIO_NOP_DELAY udelay(1);
#define MDIO_PULSE_P  _rtl865x_setGpioDataBit(smi_SCK, 0); MDIO_NOP_DELAY; _rtl865x_setGpioDataBit(smi_SCK, 1); MDIO_NOP_DELAY 

//gpio32:clk gpio33:dat
#define LS2H_GPIO_CFG_REG (*(volatile int *)0xffffffffbfd010c4LL)
#define LS2H_GPIO_OE_REG  (*(volatile int *)0xffffffffbfd010d4LL)
#define LS2H_GPIO_IN_REG  (*(volatile int *)0xffffffffbfd010e4LL)
#define LS2H_GPIO_OUT_REG (*(volatile int *)0xffffffffbfd010f4LL)
...
rtk_port_macForceLinkExt0_set(MODE_EXT_MII_MAC,&mac_cfg);
rtk_port_macForceLinkExt1_set(MODE_EXT_MII_MAC,&mac_cfg);
rtk_port_rgmiiDelayExt0_set(0,7);
rtk_port_rgmiiDelayExt1_set(0,7);

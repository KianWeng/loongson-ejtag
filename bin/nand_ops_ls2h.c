...
#define RAM_ADDR            0xa0080000
#define DMA_DESP            0xa0090000
#define NAND_TMP            0xa00a0000
...
#if 1
/*ls2h*/
#define _NAND_BASE	     0x1fee0000
#define ORDER_REG_ADDR		0xbfd00100
#define  LS2H_CHIP_SAMP3_REG 0xbfd0021c
#else
/*ls1a*/
...
int mymain(char *cmd,...)
{
	...
	arg=ap;
	printf("cmd=%s\n",cmd);
	if(*(volatile int *)LS2H_CHIP_SAMP3_REG) ls2h02 = 1;
	else ls2h02 = 0;
	for(i=0;cmd[i];i++)
	{
		switch(cmd[i]){

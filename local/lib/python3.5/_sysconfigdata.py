...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'gcc -pthread -shared -static -static-libgcc -Wl,-S',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-fwrapv -O3 -Wall -Wstrict-prototypes -static',
 'CFLAGSFORSHARED': '',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-static',
 'CONFIGURE_CFLAGS_NODIST': '',
 'CONFIGURE_CPPFLAGS': '-static',
 'CONFIGURE_LDFLAGS': '-static -static-libgcc -Wl,-S',
 'CONFIG_ARGS': "'LDFLAGS=-static -static-libgcc -Wl,-S' 'CPPFLAGS=-static' "
                "'CFLAGS=-static'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.5m',
 'COREPYTHONPATH': ':plat-linux',
 'COVERAGE_INFO': '/qiaochong/python/python3.5-3.5.1/coverage.info',
 'COVERAGE_REPORT': '/qiaochong/python/python3.5-3.5.1/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -IInclude -I./Include -static',
 'CXX': 'g++ -pthread',
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-35m-i386-linux-gnu.so',
 'FILEMODE': 644,
 ...
 'LDFLAGS': '-static -static-libgcc -Wl,-S',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.5m.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -static -static-libgcc -Wl,-S',
 'LDVERSION': '3.5m',
 'LIBC': '',
 ...
 'MODOBJS': 'Modules/_threadmodule.o  Modules/signalmodule.o  '
            ...
            'Modules/symtablemodule.o  Modules/mathmodule.o Modules/_math.o  '
            'Modules/_struct.o  Modules/selectmodule.o  Modules/mmapmodule.o  '
            'Modules/socketmodule.o  Modules/md5module.o  '
            'Modules/_codecs_cn.o  Modules/xxsubtype.o',
 'MODULE_OBJS': '\\',
 'MULTIARCH': '',
 ...
 'PY_CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -fwrapv -O3 -Wall -Wstrict-prototypes -static',
 'PY_CFLAGS_NODIST': '',
 'PY_CORE_CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code '
                   '-DNDEBUG -g -fwrapv -O3 -Wall -Wstrict-prototypes -static  '
                   '-I. -IInclude -I./Include -static  -DPy_BUILD_CORE',
 'PY_CPPFLAGS': '-I. -IInclude -I./Include -static',
 'PY_FORMAT_LONG_LONG': '"ll"',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-static -static-libgcc -Wl,-S',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 0,
 'Py_HASH_ALGORITHM': 0,
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-35m-i386-linux-gnu',
 ...
 'abs_builddir': '/qiaochong/python/python3.5-3.5.1',
 'abs_srcdir': '/qiaochong/python/python3.5-3.5.1',
